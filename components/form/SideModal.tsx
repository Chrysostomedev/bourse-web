...
export default function SideModal({
    ...
    return (
        <div className="fixed inset-0 z-[9998] flex items-stretch justify-end pointer-events-none">
            {/* Overlay */}
            <div
            ...
            {/* Panel */}
            <div className={`relative z-[9999] w-full ${width} bg-white h-full shadow-2xl flex flex-col animate-in slide-in-from-right duration-300 pointer-events-auto`}>
                {/* Header */}
